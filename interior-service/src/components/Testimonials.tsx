const TESTIMONIALS = [
  {
    ...
    quote: "Luxe Interiors transformed our empty penthouse into the home of our dreams. Every detail was thoughtfully considered — from the bespoke furniture to the hand-sourced artwork. Truly life-changing.",
    rating: 5,
  },
  {
    name: 'James Whitmore',
    ...
    quote: "Our office redesign by Luxe Interiors boosted team morale and impressed every client who visited. The ROI on great design is real — productivity up 30% since the renovation.",
    rating: 5,
  },
  {
    ...
    quote: "As someone with a very particular aesthetic, I was skeptical anyone could match my vision. Luxe Interiors not only matched it — they exceeded it. My atelier is breathtaking.",
    rating: 5,
  },
];
