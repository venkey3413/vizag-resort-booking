...
export default function Navbar() {
  ...
  return (
    <nav className="vrb-navbar" style={{ background: scrolled ? undefined : 'linear-gradient(135deg, rgba(30,30,30,0.95), rgba(60,40,20,0.92))', padding: '8px 0' }}>
      <div className="vrb-nav-container">
        <a href="#" className="vrb-logo" style={{ gap: '10px' }}>
          <img 
          ...
          />
          <div>
            <div className="vrb-brand-top" style={{ fontSize: '16px', lineHeight: '1.2' }}>INTERIORS</div>
            <div className="logo-caption" style={{ fontSize: '10px', lineHeight: '1.2' }}>Crafting Beautiful Spaces</div>
          </div>
        </a>
